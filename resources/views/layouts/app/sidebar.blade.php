    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Operaciones')" class="grid">
                <flux:sidebar.item icon="map" :href="route('routes.index')" :current="request()->routeIs('routes.index')"
                    wire:navigate>
                    Rutas
                </flux:sidebar.item>
                ...
                <flux:sidebar.item icon="truck" :href="route('dashboard')" :current="request()->routeIs('dashboard')"
                    wire:navigate>
                    Entragas
                </flux:sidebar.item>
            </flux:sidebar.group>
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Inventario')" class="grid">
                <flux:sidebar.item icon="cube" :href="route('dashboard')"
                    :current="request()->routeIs('dashboard')" wire:navigate>
                    Garrafones
                </flux:sidebar.item>

                <flux:sidebar.item icon="arrows-right-left" :href="route('dashboard')"
                    :current="request()->routeIs('dashboard')" wire:navigate>
                    Movimientos
                </flux:sidebar.item>
            </flux:sidebar.group>
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Clientes')" class="grid">
                <flux:sidebar.item icon="user-group" :href="route('dashboard')"
                    :current="request()->routeIs('dashboard')" wire:navigate>
                    Clientes
                </flux:sidebar.item>
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Usuarios')" class="grid">
                ...
                <flux:sidebar.item icon="user-circle" :href="route('users.index')"
                    :current="request()->routeIs('users.*')" wire:navigate>
                    Roles
                </flux:sidebar.item>
            </flux:sidebar.group>
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Finanzas')" class="grid">
                <flux:sidebar.item icon="arrow-trending-up" :href="route('dashboard')"
                    :current="request()->routeIs('dashboard')" wire:navigate>
                    Ingresos
                </flux:sidebar.item>

                <flux:sidebar.item icon="arrow-trending-down" :href="route('dashboard')"
                    :current="request()->routeIs('dashboard')" wire:navigate>
                    Gastos
                </flux:sidebar.item>
            </flux:sidebar.group>
